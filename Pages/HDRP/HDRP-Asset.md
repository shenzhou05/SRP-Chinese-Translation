...
| **Volumetrics** | Enables support for volumetrics. This allows you to use **Volumetric Fog** for the **Fog Type** in the [Visual Environment](https://github.com/Unity-Technologies/ScriptableRenderPipeline/wiki/HDRP-Visual-Environment). |
...
| **Probe Cache Size** | The maximum resolution of the Probe Cache. Defines how many Reflection Probe cube maps HDRP can save in cache. |

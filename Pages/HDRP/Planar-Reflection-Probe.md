Planar Reflection Probes are one of the [Reflection Probes](https://github.com/Unity-Technologies/ScriptableRenderPipeline/wiki/Reflection-Probes-Intro) that the High Definition Render Pipeline (HDRP) provides to help you create reactive and accurate reflective Materials.
...
![](https://github.com/Unity-Technologies/ScriptableRenderPipeline/wiki/Pages/HDRP/Images/PlanarReflectionProbe1.png)
...
| **Volume Anchor Override** | Set the Transform that the [Volume](https://github.com/Unity-Technologies/ScriptableRenderPipeline/wiki/Volumes) system uses to handle the position of this Planar Reflection Probe. For example, if you want this Planar Reflection Probe to match post-processing effects with the view Camera, set this property to the view Camera’s Transform. The Volume system then uses the Camera’s position to process which Volume affects this Planar Reflection Probe. |

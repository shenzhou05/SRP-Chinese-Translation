...
Frame Settings are settings HDRP uses to render Cameras, realtime, baked, and custom reflections. You can set the default Frame Settings for each of these three individually from within a [HDRP Asset](https://github.com/Unity-Technologies/ScriptableRenderPipeline/wiki/HDRP-Asset). Open a HDRP Asset in the Inspector and navigate to the __Default Frame Settings For__ section.

...
1. Prepare a greyscale 2D texture with values in the [0, 1] range of size 1024x32 which is a 3D texture of size 32x32x32 with 32 slices laid out one after another.
